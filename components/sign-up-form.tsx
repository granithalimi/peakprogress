      ...
      <Card className="border border-slate-200/80 bg-white shadow-lg shadow-slate-100/80 rounded-2xl">
        <CardHeader className="space-y-1.5 pb-6 pt-8 text-center sm:text-left">
          ...
          <CardDescription className="text-sm text-slate-500">
            Start tracking your workout routines and progression today.
          </CardDescription>
        </CardHeader>
        <CardContent className="pb-8">
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="repeat-password" className="text-xs font-semibold uppercase tracking-wider text-slate-700">
                Confirm Password
              </Label>
              <Input
                id="repeat-password"
